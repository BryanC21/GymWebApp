...
import './../styles/LoginSelectorMember.css'
import ImgAsset from '../public'
import {Link} from 'react-router-dom'
export default function LoginSelectorMember () {
	return (
		<div className='LoginSelectorMember_LoginSelectorMember'><div className='beautifulyoungsportywomantrainingworkoutgym1' style={{backgroundImage: `linear-gradient(0deg, rgba(0,0,0,0.40), rgba(0,0,0,0.40)),url(${ImgAsset.LoginSelector_beautifulyoungsportywomantrainingworkoutgym1})`}}/><div className='vecteezy_asianwomanisexercisinginagymwithapersonaltrainer_24406531' style={{backgroundImage: `linear-gradient(0deg, rgba(0,0,0,0.40), rgba(0,0,0,0.40)),url(${ImgAsset.LoginSelectorStaff_vecteezy_asianwomanisexercisinginagymwithapersonaltrainer_24406531})`}}/>
