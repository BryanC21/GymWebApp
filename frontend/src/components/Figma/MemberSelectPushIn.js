...
import '../../styles/MemberSelectPushIn.css'
import ImgAsset from '../../public'
import {Link} from 'react-router-dom'
export default function MemberSelectPushIn () {
	return (
		<div className='MemberSelectPushIn_MemberSelectPushIn'><div className='vecteezy_healthylifestyledoodlehanddrawnsetcollectionswith_1' style={{backgroundImage: `linear-gradient(0deg, rgba(0,0,0,0.60), rgba(0,0,0,0.60)),url(${ImgAsset.StaffLogin_vecteezy_healthylifestyledoodlehanddrawnsetcollectionswith_1})`}}/>
			...
			<div className='account_circle'>
				<img className='Vector' src = {ImgAsset.MemberSelectPushIn_Vector} />
				<img className='Vector_1' src = {ImgAsset.MemberSelectPushIn_Vector_1} />
			</div>
			<span className='WelcomeOwner'>Welcome, Owner!</span>
			<div className='MemberDetWithin'>
				<span className='MemberSpace'>Member Space</span>
				...
				<div className='Group5_1'>
					<div className='Rectangle5_6'/>
					<span className='Modify'>Modify</span>
				</div>
				<div className='Rectangle13'/>
				<div className='Rectangle15'/>
				<div className='Rectangle14'/>
				<span className='CurrentMembers'>Current Members</span>
				<div className='Group8'>
					<div className='Rectangle5_7'/>
					<span className='SearchbyName'>Search by Name</span>
				</div>
				<div className='Group9'>
					<div className='Rectangle5_8'/>
					<span className='SearchbyMemberID'>Search by Member ID</span>
				</div>
				<div className='search'>
					<img className='Vector_2' src = {ImgAsset.MemberSelectPushIn_Vector_2} />
					<img className='Vector_3' src = {ImgAsset.MemberSelectPushIn_Vector_3} />
				</div>
				<div className='search_1'>
					<img className='Vector_4' src = {ImgAsset.MemberSelectPushIn_Vector_4} />
					<img className='Vector_5' src = {ImgAsset.MemberSelectPushIn_Vector_5} />
				</div>
				<div className='Rectangle16'/>
				<span className='AakashDev'>Aakash, Dev</span>
				<span className='Age24'>Age: 24</span>
				<span className='_123456'>#123456</span>
				<span className='AaronThomas'>Aaron, Thomas</span>
				<div className='keyboard_arrow_down'>
					<img className='Vector_6' src = {ImgAsset.MemberSelectPushIn_Vector_6} />
					<img className='Vector_7' src = {ImgAsset.MemberSelectPushIn_Vector_7} />
				</div>
				<div className='keyboard_arrow_down_1'>
					<img className='Vector_8' src = {ImgAsset.MemberSelectPushIn_Vector_8} />
					<img className='Vector_9' src = {ImgAsset.MemberSelectPushIn_Vector_9} />
				</div>
				<span className='MemberSince2019MembershipvalidityUntil2023TrainerYes6TotalCharges180005000AmountOwedNIL'>Member Since: 2019<br/>Membership validity: Until 2023<br/>Trainer : Yes (#6)<br/>Total Charges: 18,000 + 5,000<br/>Amount Owed: NIL<br/></span>
				<div className='Group10'>
					...
					<span className='FitnessRegime'>Fitness Regime</span>
				</div>
				...
				<div className='Group12'>
					...
					<div className='Group11_1'>
						...
						<div className='Ellipse2_3'/>
						<div className='Ellipse3_3'/>
						<div className='Ellipse4_3'/>
						<div className='Rectangle11_3'/>
				...
				<div className='keyboard_arrow_down_2'>
					<img className='Vector_10' src = {ImgAsset.MemberSelectPushIn_Vector_10} />
					<img className='Vector_11' src = {ImgAsset.MemberSelectPushIn_Vector_11} />
				</div>
				<div className='keyboard_arrow_down_3'>
					<img className='Vector_12' src = {ImgAsset.MemberSelectPushIn_Vector_12} />
					<img className='Vector_13' src = {ImgAsset.MemberSelectPushIn_Vector_13} />
				</div>
			</div>
		</div>
	)
