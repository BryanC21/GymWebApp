...
export default function LoggedIn () {
	return (
		<div className='LoggedIn_LoggedIn'><div className='vecteezy_healthylifestyledoodlehanddrawnsetcollectionswith_1' style={{backgroundImage: `linear-gradient(0deg, rgba(0,0,0,0.60), rgba(0,0,0,0.60)),url(${ImgAsset.StaffLogin_vecteezy_healthylifestyledoodlehanddrawnsetcollectionswith_1})`}}/>
			...
			<div className='account_circle'>
				<img className='Vector' src = {ImgAsset.LoggedIn_Vector} />
				<img className='Vector_1' src = {ImgAsset.LoggedIn_Vector_1} />
			</div>
