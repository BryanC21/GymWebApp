...
const ListEmployees = () => {
    ...
    useEffect(() => {
        ...
        axios.get(urlPath + '/api/admin/getAllEmployees')
            .then(res => {
                                        ...
                                        <div className="col-md-4" key={activity.id}>
                                            <div className="card">
                                                <div className="card-body">
                                                    <h5 className="card-title">{activity.first_name + " " + activity.last_name + " - ID: " + activity.id}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    );
