...
export default function LoggedInMemberHighlight () {
	return (
		<div className='LoggedInMemberHighlight_LoggedInMemberHighlight'><div className='vecteezy_healthylifestyledoodlehanddrawnsetcollectionswith_1' style={{backgroundImage: `linear-gradient(0deg, rgba(0,0,0,0.60), rgba(0,0,0,0.60)),url(${ImgAsset.StaffLogin_vecteezy_healthylifestyledoodlehanddrawnsetcollectionswith_1})`}}/>
			...
			<div className='account_circle'>
				<img className='Vector' src = {ImgAsset.LoggedInMemberHighlight_Vector} />
				<img className='Vector_1' src = {ImgAsset.LoggedInMemberHighlight_Vector_1} />
			</div>
